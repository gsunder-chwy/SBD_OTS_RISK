...
dt_string_start: List[str] = [d.strftime("%Y-%m-%d %H:%M:%S") for d in pd.date_range(start_date,end_date,freq='D')]
dt_string_end: List[str] = [d.strftime("%Y-%m-%d %H:%M:%S") for d in pd.date_range(start_date + timedelta(days=1),
