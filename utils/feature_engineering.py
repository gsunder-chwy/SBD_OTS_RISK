...
def add_day_of_week(labor_plan_df):
    # add day of the week
...
def fc_feature_gen(labor_plan_df, shipped_units_data, fc_details):
    # fc_type
...
def feature_engineering(shipped_units_data, labor_plan_df):
